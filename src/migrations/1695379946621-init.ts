...
export class Init1695379946621 implements MigrationInterface {
    name = 'Init1695379946621'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_2d0b98e9ed2e7dc806d2301dd38" FOREIGN KEY ("userUserId") REFERENCES "users"("userId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_501578f69c24fba9ec425535917" FOREIGN KEY ("cardId") REFERENCES "card"("cardId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_2d0b98e9ed2e7dc806d2301dd38"`);
